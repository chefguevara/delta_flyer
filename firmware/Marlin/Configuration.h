...
#define STRING_CONFIG_H_AUTHOR "@markosdeltomate" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Delta Flyer"
...
#define DELTA
  ...
  #define DELTA_HEIGHT 186.63            // (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.000, -0.482, -1.180 } // Get these values from G33 auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 107.16              // (mm) Get this value from G33 auto calibrate

  // Trim adjustments for individual towers
  // tower angle corrections for X and Y tower / rotate XYZ so Z tower angle = 0
  // measured in degrees anticlockwise looking from above the printer
  #define DELTA_TOWER_ANGLE_TRIM {  -0.495, 0.000, -0.202 } // Get these values from G33 auto calibrate
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 188 }  // default steps per unit for Kossel (GT2, 20 tooth)
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 500, 55 }
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 27, -2.10 }
...
#define HOMING_FEEDRATE_Z  1500 // (200*30)
//TODO: reset homing feedrate
