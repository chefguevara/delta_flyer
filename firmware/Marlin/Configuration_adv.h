...
//
// fixes issues with display beeping and not working
//
 ...
 */
  ...
  #define MESH_MIN_X MESH_INSET - DELTA_PRINTABLE_RADIUS
  #define MESH_MIN_Y MESH_INSET - DELTA_PRINTABLE_RADIUS
  #define MESH_MAX_X DELTA_PRINTABLE_RADIUS - (MESH_INSET)
  #define MESH_MAX_Y DELTA_PRINTABLE_RADIUS - (MESH_INSET)
#endif
